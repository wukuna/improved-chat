...
The collapsible chat behavior includes BSD-2-Clause code derived from work by stutify:
- Repository: `https://github.com/stutify/runelite-plugins`
- Copyright: Copyright (c) 2025, stutify

The resizable chat behavior includes BSD-2-Clause code derived from work by shanktank:
